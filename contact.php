...
<div class="grid grid-cols-1 lg:grid-cols-3">
    ...
    <h3 class="text-lg font-medium text-violet-600">Information pour nous contacter :</h3>
    <p class="mt-6 max-w-3xl text-base text-violet-600">Contactez notre équipe pour en savoir plus sur la Blockchain et les Smartcontracts. <br/> Notre équipe est à votre disposition pour répondre à vos questions au plus vite !</p>
    <dl class="mt-8 space-y-6">
        <dt><span class="sr-only">numero de telephone</span></dt>
        <dd class="flex text-base text-violet-600 pt-10">
        <PhoneIcon class="h-6 w-6 flex-shrink-0 text-teal-200" aria-hidden="true" />
        <span class="ml-3">+33 01 39 53 22 50</span>
        </dd>
        <dt><span class="sr-only">Email</span></dt>
        <dd class="flex text-base text-violet-600 pt-10">
        <EnvelopeIcon class="h-6 w-6 flex-shrink-0 text-teal-200" aria-hidden="true" />
        <span class="ml-3">contact@blockchain.fr</span>
        </dd>
    </dl>
    <ul role="list" class="mt-8 flex space-x-12 pt-10 ml-6">
        <li>
        <a class="text-violet-600 hover:text-teal-100" href="#">
    ...
    <h3 class="text-lg font-medium text-warm-gray-900">Envoyez nous un message :</h3>
    <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
        <div>
        <label for="first-name" class="block text-sm font-medium text-warm-gray-900">Prenom</label>
        <div class="mt-1">
        ...
        <div>
        <label for="email" class="block text-sm font-medium text-warm-gray-900">Adresse mail</label>
        <div class="mt-1">
        ...
        <label for="subject" class="block text-sm font-medium text-warm-gray-900">Sujet</label>
        <div class="mt-1">
        ...
        <div class="flex justify-between">
            ...
            <span id="message-max" class="text-sm text-warm-gray-500">Max. 500 mots</span>
        </div>
        <div class="mt-1">
        ...
        <button type="submit" class="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-orange-400 px-6 py-3 text-base font-medium text-violet-800 shadow-sm hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">Envoyer</button>
        </div>
    </form>
    </div>
</div>
